...
On a new machine or in CI, pull your secrets down:
...
<Columns cols={3}>
  <Card title="CLI commands" icon="terminal" href="/cli/commands">
    Every command and flag in the Krypt CLI.
  </Card>
  <Card title="Projects and environments" icon="folder" href="/concepts/projects-and-environments">
    Organize secrets by project and stage.
  </Card>
  <Card title="Roles and permissions" icon="shield" href="/concepts/roles-and-permissions">
    Share secrets with your team safely.
  </Card>
</Columns>
